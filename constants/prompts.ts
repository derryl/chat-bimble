...
export const proposeFurtherQuestionsPrompt = `The following is a "Prompt" you received from a user, and the "Answer" you gave for that prompt. Based on these inputs, I would like you to provide a list of 8 additional suggested prompts that a user might choose to ask you. These prompts should provide interesting avenues for further exploration by the user. Your response will be formatted as a JSON Array of Objects. Each of your suggestions should be an Object in this Array. Each Object will have a single "text" field which contains the text of your suggested prompt.
